  ...
  return (
    <section className="space-y-6">
      <div className="flex justify-between items-end border-b border-black/40 dark:border-white/40 pb-3">
        ...
        <Link
          href={"/lessons"}
          className="flex items-center gap-1 text-[11px] font-bold uppercase tracking-widest text-black dark:text-white border-b-2 border-black dark:border-white pb-0.5 hover:opacity-70 transition-all cursor-pointer shrink-0"
        >
          Review All Lessons
